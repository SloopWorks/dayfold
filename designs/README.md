...
| Smart Briefings V0.1 pilot | [`PROMPT-smart-briefings-v0.1-claude-bridge.md`](PROMPT-smart-briefings-v0.1-claude-bridge.md) | Spike-informed Claude-only manual design prompt: Gmail remains in Claude, one Hub, at most one source-owner-private proposal, exact restricted-audience acceptance, browser OAuth pairing, and honest revoke. Hi-fi pending; no live/private-data build authorized. |
...
| Local search | [`local-search/Index.dc.html`](local-search/Index.dc.html) | Exploratory on-device search gallery: exact/phrase/typo states, honest match marks, compact mixed results, offline/cold/archived edges, canonical arrival, adaptive layout, and a clearly deferred semantic comparison. **Awaiting ADR 0008 operator sign-off; no build authorized.** |
