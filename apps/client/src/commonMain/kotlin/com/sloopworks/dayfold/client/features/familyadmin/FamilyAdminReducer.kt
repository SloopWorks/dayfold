...
fun reduceFamilyAdmin(state: AppState, action: Any): AppState = when (action) {
  ...
  is OpenInvite -> state.copy(mintedInvite = null, mintError = null, inviteBusy = false)
  ...
  is InviteDismissed -> state.copy(mintedInvite = null, mintError = null, inviteBusy = false)
