...
enum class Route { Loading, SignIn, AuthError, CreateFamily, Feed, Hubs, Account, SmartBriefings, SmartContent, JoinInvite, Members, Invite, Devices, EnterCode, AuthorizeDevice, ScanPrimer, ScanDevice, ScanDenied, Proximity, CalendarSettings, CalendarReview, CalendarImport }
