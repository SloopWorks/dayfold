...
This repository publishes development builds of `com.sloopworks.dayfold.dev` (Gradle variant `debug`)
to the Shipyard Deploy project `dayfold`. Configuration lives in `.shipyard-deploy.yaml`;
