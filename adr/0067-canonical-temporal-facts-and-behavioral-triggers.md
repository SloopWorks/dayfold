...
**Proposed** 2026-09-01. Operator-gated: this changes the authored content
contract, temporal semantics, CLI write gate, API persistence shape, and the
inputs to the on-device Now, notification, timeline, and Calendar Check
projections. It does not take effect by merging this draft.
